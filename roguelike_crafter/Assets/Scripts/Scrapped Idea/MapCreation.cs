...
public class MapCreation : MonoBehaviour
{
   ...
   public float noiseScale, lac, heightMultuplier;
   [Range(0, 1)]
   public float persis;
   ...
   public void GenerateMap()
   {
       ...
       {
           display.DrawMesh(MeshGen.GenerateTerrainMesh(noiseMap, heightMultuplier, meshHeightCurve), TextGen.textureFromCM(colorMap, mapWidth, mapHeight));
       }
