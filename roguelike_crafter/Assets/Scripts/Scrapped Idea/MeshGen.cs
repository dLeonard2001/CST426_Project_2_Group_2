...
{
    public static MeshInfo GenerateTerrainMesh(float[,] heightMap, float heightMultuplier, AnimationCurve AC)
    {
        ...
        for (int y = 0; y < height; y++)
        {
            ...
            {
                meshInfo.verts[vertLocation] = new Vector3(northWestX + x, AC.Evaluate(heightMap[x, y]) * heightMultuplier, northWestZ - y);
